...
```bash
- quarto render index.qmd --to insee-$COULEURFORMAT-revealjs -P annee:"2023" -P codeRegion:"75" # OU
- Rscript -e 'quarto::quarto_render(input = "index.qmd", output_format = "insee-$COULEURFORMAT-revealjs", execute_params = list("annee" = "2023", "codeRegion" = "75"))'


# Si vous utilisez par défaut l'entête yml du fichier .qmd et que vous voulez surcharger sur la pages gitlab avec les valeurs du fichier params.yml
