...
::: {.callout-note}
Le choix a été fait de gérer les paramètres d'exécution uniquement via le fichier `params.yml` pour faciliter leur gestion car l'usage de ce fichier permet de centraliser les variables et d'éviter de considérer les différences possibles entre l'usage des versions en local et leur surcharge après déploiement sur les pages gitlab dans le cas d'usage des paramètres en entête de fichier qmd.
:::
