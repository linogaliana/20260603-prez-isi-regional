...
#### Exemple de jeu de données filtré sur le département
...
::: {.callout-note}
Dans ce dernier exemple, ce ne sont pas les paramètres en entête du fichier rendu qui sont utilisés, mais ceux du fichier `params.yml`
:::

::: {.callout-important}
Le contexte d'exécution des paramètres utilisés peut différer entre le "render" que vous faites sur votre machine, et celui qui est fait au moment du déploiement sur Gitlab si vous utilisez l'entête yml. Par souci de cohérence, il est préférable d'utiliser la même manière pour charger les paramètres.
:::
